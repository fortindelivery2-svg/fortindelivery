  ...
  return (
    <div className="p-6 animate-in fade-in duration-500">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400">Gestão financeira de saídas</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-[#2d3e52] p-6 rounded-lg shadow-lg flex items-center justify-between">
          <div>
            <p className="text-gray-400 text-sm font-medium uppercase">Total a Pagar</p>
        ...
        <div className="bg-[#2d3e52] p-6 rounded-lg shadow-lg flex items-center justify-between">
          <div>
            <p className="text-gray-400 text-sm font-medium uppercase">Total Pago</p>
            <h3 className="text-2xl font-bold text-[#00d084] mt-1">R$ {totalPago.toFixed(2)}</h3>
          </div>
          ...
          <table className="w-full whitespace-nowrap">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="py-3 px-4 text-left text-xs font-bold text-gray-400 uppercase">Descrição</th>
                <th className="py-3 px-4 text-left text-xs font-bold text-gray-400 uppercase">Fornecedor</th>
            ...
            <tbody className="divide-y divide-gray-700">
              {filteredContas.map((conta) => (
                <tr key={conta.id} className="hover:bg-[#374151] transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-300">{conta.fornecedor}</td>
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-[#2d3e52] rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto border border-gray-700 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-gray-300 text-sm font-medium mb-2">Fornecedor *</label>
                <input
                  type="text"
                  required
