...
const PDVPage = () => {
  ...
  return (
    <div className="p-6">
      ...
      <CloseCashierModal isOpen={showCloseCashier} onClose={() => setShowCloseCashier(false)} onConfirm={handleCloseCashier} session={cashierSession} currentBalance={caixaSaldo} />
